...
.parallax {
    background-image: linear-gradient(rgba(25, 25, 25, 0.65), rgba(0, 0, 0, 0.7)), url(images/search.jpg);
    width: 100%;
    opacity: 0.9;
    min-height: 700px;
...
<?php include('includes/header.php');?>
    ...
    <div class="container" style="margin-bottom:190px;">
        ...
        <h1 class="mt-4 mb-3"  style="color:#fff;">Search <small>Donor</small></h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic"  style="color:#fff;">Location </div>
